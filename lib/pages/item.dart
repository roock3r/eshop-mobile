                                          ...
                                          onPressed: () {
                                            if ((cart.currentshopId == null) ||
                                              ...
                                              _scaffoldKey.currentState
                                                  .showSnackBar(SnackBar(
                                                content: Text(
                                                    'You are adding an item from another shop would you like to clear your cart for this current store and add this item for this store in your cart ?'),
