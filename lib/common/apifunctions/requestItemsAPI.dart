...
class requestItemsAPI extends InheritedWidget {
  ...
  static requestItemsAPI of(BuildContext context){
    return context.inheritFromWidgetOfExactType(requestItemsAPI) as requestItemsAPI;
  }
